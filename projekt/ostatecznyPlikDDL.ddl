...
create or replace PROCEDURE nowaGra
    (vNazwa IN VARCHAR2,
    vCena IN NUMBER,
    vRok_wydania IN VARCHAR2,
    vStan IN NUMBER,
    vWydawnictwo IN VARCHAR2,
    vMin_gracze IN NUMBER,
    vMax_gracze IN NUMBER,
    vMin_wiek IN NUMBER,
    vCzas_gry IN NUMBER) AS
    vWydaw NUMBER;
BEGIN
    SELECT ID_wydawnictwa INTO vWydaw FROM Wydawnictwo WHERE Nazwa = vWydawnictwo;
    INSERT INTO Produkt VALUES(PRODUKT_ID_PRODUKTU_SEQ.nextval, vNazwa, vCena, vRok_wydania, vStan, vWydaw, 'g');
    INSERT INTO gra_planszowa VALUES(PRODUKT_ID_PRODUKTU_SEQ.currval, vMin_gracze, vMax_gracze, vMin_wiek, vCzas_gry);
END nowaGra;
...
create or replace PROCEDURE nowaKsiazka
    ...
    vFormat IN VARCHAR2,
    vSeria IN VARCHAR2) AS
    vWydaw NUMBER;
BEGIN
    SELECT ID_wydawnictwa INTO vWydaw FROM Wydawnictwo WHERE Nazwa = vWydawnictwo;
    INSERT INTO Produkt VALUES(PRODUKT_ID_PRODUKTU_SEQ.nextval, vNazwa, vCena, vRok_wydania, vStan, vWydaw, 'k');
    INSERT INTO Ksiazka VALUES(PRODUKT_ID_PRODUKTU_SEQ.currval, vTyp_okladki, vLiczba_stron, vFormat, vSeria);
END nowaKsiazka;
